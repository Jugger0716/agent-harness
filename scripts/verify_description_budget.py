...
TOTAL_CEILING = 7827  # at this commit (C5); was 6841 at C2 of review-fixes-v8-12 -- +986 for the /harness split (470 -> 627 + 435 + 394)
...
PER_SKILL_CEILING = {
    ...
    "deep-review": 668,
    "handoff": 617,
    "harness": 627,       # at this commit (C5); was 470 at 4295156 -- the entry point now names its two siblings
    "harness-build": 394, # at this commit (C5) -- new skill (split of harness)
    "harness-gate": 435,  # at this commit (C5) -- new skill (split of harness)
    "md-generate": 469,
    "md-optimize": 194,
...
LOWER_BOUND = {
    ...
    "harness": 400,      # landed 627 at C5; the entry point must keep naming the pipeline it fronts
}
